...
try
{
    ...
    string FolderOrigen = Dts.Variables["User::FolderOrigenCliente"].Value.ToString();
    string tabla = Dts.Variables["User::TablaDestinoCliente"].Value.ToString();
    ...
    foreach (string fileName in fileEntries)
    {
        ...
        while ((line = SourceFile.ReadLine()) != null)
        {
            if (counter > 0)
            {
                ...
                string query = "INSERT INTO " + tabla + " (codigoCliente, nombreCliente, tipoCliente, direccionCliente, correoCliente) Values('" + campos[0] + "','" + campos[1] + "','" + campos[2] + "','" + campos[3] + "','" + campos[4] + "')";
